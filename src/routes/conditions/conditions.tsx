	...
	return (
		<div className={styles.wrapper}>
			<div className={styles.title}>
				...
				<span>
					При организации торжества используется индивидуальный
					подход, учитывая пожелания гостей
				</span>
			</div>
			<div className={styles.description}>
				...
				<div className={styles.menu}>
					...
					<span>
						250 гр. - Горячее, согласовывая 4-6 горячих блюд;
					</span>
			...
			<div className={styles.alcohol}>
				...
				<span>
					Также можно приобрести алкоголь по специальному банкетному
					предложению
				</span>
			</div>
			<div className={styles.rent}>
				...
				<span>
					каждый последующий час - 20 000 рублей,(продление возможно с
					ограничением по звуку)
				</span>
			</div>
			...
			<div className={styles.interior}>
				...
				<span>
					Цветочные композиции (вазы с цветами) на столах,светильники,
					свечи
				</span>
			</div>
			<div className={styles.soundHardware}>
				...
				<span>
					Аренда оборудования - 12 000 рублей (2 колонки, 2 микрофона
					и стойки, микшер, сцена, световые головы)
				</span>
			</div>
