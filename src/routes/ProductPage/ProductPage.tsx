...
import { useProductNavigation } from './ProductPage.hooks';
import styles from './ProductPage.module.css';

type ProductPageProps = Pick<PageProps<'/menu/[category]/[product]'>, 'params'>;

export default async function ProductPage({ params }: ProductPageProps) {
	const { category, product } = await params;
	const { nextProduct, previousProduct } = await useProductNavigation({
		category,
		product,
	});
